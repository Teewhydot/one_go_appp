...
const boldBlueStyle = TextStyle(color: Color(0xff2b47fc),fontSize: 25.0, fontWeight: FontWeight.bold);
const normalBlueStyle = TextStyle(color: Color(0xff2b47fc),fontSize: 25.0, fontWeight: FontWeight.normal);
const normalBlackStyle = TextStyle(color: textColor,fontSize: 15.0, fontWeight: FontWeight.normal);
